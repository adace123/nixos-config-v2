        ...
        yield Static(
            "\n".join(
                [
                    ...
                    "  J K only bites with sort = \"manual\": sorted columns put the",
                    "  freshest card first, wherever the board file had it.",
                    ...
                    "  and its agent is left running unless auto_archive_agent is on, which",
                    "  stops it as d does. Press v to show the Archived column, then u to",
                    "  restore one (or herdr-kanban unarchive <id>).",
                    "",
